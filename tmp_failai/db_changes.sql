...
ALTER TABLE `treniruociu_planai` ADD `rusis` ENUM('cardio','jegos','bfp','iötvermes','mases auginimas','raumenu ryökinimas','atstatomoji','lankstumo','svorio metimo','kita') NULL DEFAULT 'kita' AFTER `pav`, ADD INDEX (`rusis`);
