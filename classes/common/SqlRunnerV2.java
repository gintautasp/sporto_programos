...
public class SqlRunnerV2{
	
	public Connection connection = null;
	String lentele = "treniruociu_planai";
	String[] laukai = ["id", "pav"];
	SqlQueriesV2 sqlQuery = new SqlQueriesV2(lentele, laukai);
